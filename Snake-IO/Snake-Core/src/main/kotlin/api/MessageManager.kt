...
import api.controllers.ReceiverController
import api.controllers.SenderController
import dto.messages.*
import models.contexts.NetworkContext
import models.core.*
import models.requests.DeputyListenTaskRequest
import models.util.AckConfirmation
...
class MessageManager(
    ...
    private fun checkSteerRequest(state: models.states.State) {
    ...
    private fun checkJoinRequest(state: models.states.State) {
    ...
    private fun checkLeaveRequest(state: models.states.State) {
    ...
    private fun checkDeputyListenRequest(state: models.states.State) {
